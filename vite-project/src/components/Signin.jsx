...
const Email = () => {
  return (
    <form onSubmit={(e) => e.preventDefault()}>
      <div className="mb-3">
        <label htmlFor="email-input" className="mb-1.5 block text-white">
          Email
        </label>
        <input
          id="email-input"
          ...
          className="w-full rounded-md border border-zinc-700 bg-transparent px-3 py-2 placeholder-white ring-1 ring-transparent transition-shadow focus:outline-0 focus:ring-blue-700"
        />
      </div>
      <div className="mb-6">
